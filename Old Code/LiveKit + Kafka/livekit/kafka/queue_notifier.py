...
+--------------------------------------------+
    ...
    v
+--------------------------------------------+
| <QueueNotifier> -> broadcast_queue_positions() |
| * send position updates to rooms           |
+--------------------------------------------+
    |
    ...
    v
+--------------------------------------------+
| <QueueNotifier> -> notify_call_starting()  |
| * send call_start to browser               |
+--------------------------------------------+
    |
...
+--------------------------------------------+
| <QueueNotifier> -> _send_to_room()         |
| * send data via LiveKit API                |
+--------------------------------------------+
    |
    |----> <SendDataRequest> -> __init__()
    |----> <LiveKitAPI> -> send_data()
    |
    v
+--------------------------------------------+
| <QueueNotifier> -> stop()                  |
