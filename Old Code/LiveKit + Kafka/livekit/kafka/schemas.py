"""
backend/livekit/kafka/schemas.py
──────────────────────────────────────────────────────────────────────────────
Pydantic v2 message models for every Kafka topic.

All models support:
    .model_dump_json()  → bytes for Kafka producer
    Model.model_validate_json(raw) → typed object for consumers
"""
...
class CallRequest(BaseModel):
    """
    Produced by FastAPI /livekit/token.
